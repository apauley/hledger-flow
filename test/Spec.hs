...
groupedIncludeFiles = [("./base/dir1.journal", ["./base/dir1/d1f1.journal", "./base/dir1/d1f2.journal"]),
                       ("./base/dir2.journal", ["./base/dir2/d2f1.journal", "./base/dir2/d2f2.journal"])]
...
testToIncludeFiles = TestCase (
  do
    let expected = [("./base/dir1.journal",
