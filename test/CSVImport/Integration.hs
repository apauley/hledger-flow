...
import TestHelpersTurtle (extraFiles, hiddenFiles, journalFiles, touchAll)
import Turtle
    ...
    ( sh
        ( do
            ...
            let includeMap =
                  Map.singleton
                    includeFile
                    [ ownerDir </> "bank1" </> "2019-include.journal",
  ...
  TestCase
    ( sh
        ( do
            ...
            let allYears =
                  [ tmpdir </> "import/jane/bogartbank/checking/all-years.journal",
