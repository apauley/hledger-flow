...
You can read it like a normal article, either [[https://github.com/apauley/hledger-makeitso/blob/master/docs/part3.org][on the web]] or [[https://pauley.org.za/hledger-makeitso/part3.html][as a slide show]].
