...
Let's run it verbosely for a change:

#+REVEAL: split

#+NAME: import3
#+BEGIN_SRC sh :results org :exports both
hledger-makeitso import --verbose ./my-finances
#+END_SRC

#+RESULTS: import3
#+BEGIN_SRC org
2019-03-04 23:25:57.751060758 SAST	hledger-makeitso Collecting input files...
2019-03-04 23:25:57.872693876 SAST	hledger-makeitso Found 1 input files
2019-03-04 23:25:57.872873856 SAST	hledger-makeitso Found a preprocess file at 'import/gawie/bogart/cheque/preprocess'
2019-03-04 23:25:57.873181697 SAST	hledger-makeitso Begin: executing 'import/gawie/bogart/cheque/preprocess' on 'import/gawie/bogart/cheque/1-in/2016/123456789_2016-03-30.csv'
2019-03-04 23:25:57.89569617 SAST	hledger-makeitso End:   executing 'import/gawie/bogart/cheque/preprocess' on 'import/gawie/bogart/cheque/1-in/2016/123456789_2016-03-30.csv' (0.022211083s)
2019-03-04 23:25:57.896106771 SAST	hledger-makeitso Did not find a construct file at 'import/gawie/bogart/cheque/construct'
I couldn't find an hledger rules file while trying to import
...
│   │   │   │   ├── 3-journal-include.journal
│   │   │   │   ├── bogart-cheque.rules
│   │   │   │   └── preprocess -> ../../../../fnb-csv-demoronizer/fnb-csv-demoronizer
│   │   │   └── cheque-include.journal
│   │   └── bogart-include.journal
│   └── gawie-include.journal
├── import-include.journal
└── makeitso.journal
