...
logVerbose :: ImportOptions -> Text -> Shell ()
logVerbose opts msg = if (verbose opts) then logErr msg else return ()

logVerboseTime :: ImportOptions -> Text -> IO a -> IO (a, NominalDiffTime)
...
verboseTestFile :: ImportOptions -> FilePath -> Shell Bool
...
relativeToBase :: ImportOptions -> FilePath -> FilePath
...
toIncludeFiles :: ImportOptions -> Map.Map FilePath [FilePath] -> Shell (Map.Map FilePath Text)
...
extraIncludes :: ImportOptions -> [FilePath] -> [Text] -> [FilePath] -> Shell (Map.Map FilePath [FilePath])
extraIncludes opts = extraIncludes' opts Map.empty

extraIncludes' :: ImportOptions -> Map.Map FilePath [FilePath] -> [FilePath] -> [Text] -> [FilePath] -> Shell (Map.Map FilePath [FilePath])
...
extraIncludesForFile :: ImportOptions -> FilePath -> [Text] -> [FilePath] -> Shell (Map.Map FilePath [FilePath])
...
relativeFilesAsText :: ImportOptions -> [FilePath] -> [Text]
...
groupAndWriteIncludeFiles :: ImportOptions -> [FilePath] -> Shell [FilePath]
...
writeFileMap :: ImportOptions -> Map.Map FilePath [FilePath] -> Shell [FilePath]
writeFileMap opts = writeFiles . (toIncludeFiles opts)

writeIncludesUpTo :: ImportOptions -> FilePath -> [FilePath] -> Shell [FilePath]
