...
For exammple, the presence of a file named =${BASE}/prices/2020/prices.journal= will result in some extra include file magic.
...
Here is an exammple script which downloads prices and follows the naming convention:
